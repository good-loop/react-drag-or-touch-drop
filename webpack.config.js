...
//const MiniCssExtractPlugin = require('mini-css-extract-plugin'); // no CSS

const webDir = process.env.OUTPUT_WEB_DIR || 'bin'; // output to bin
...
const baseConfig = {
	...
	// plugins: [new MiniCssExtractPlugin({ filename: 'style/main.css' })] No CSS
};
...
const configs = [
	makeConfig({filename: 'dragdrop-bundle.js', mode: 'production' }),
...
if (false && process.env.NO_PROD !== 'true') { // always production
